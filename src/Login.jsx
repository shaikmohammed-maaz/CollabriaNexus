  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-8 md:py-16 pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-20 left-20 w-80 h-80 bg-accentLight/10 rounded-full blur-3xl"
        ...
        <div className="flex-1 p-10 lg:p-12 flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-textMuted mt-2 text-sm">
              Welcome back to your learning & earning journey
            </p>
          </div>
          <h2 className="text-3xl lg:text-4xl font-bold mb-2 text-accentLight">
            Welcome Back!
          </h2>
          <p className="mb-8 text-textMuted text-lg">
            Continue your journey of knowledge and collaboration
          </p>
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="relative">
              ...
              <input
                ...
                } bg-background/70 text-text placeholder-textMuted focus:outline-none focus:ring-2 focus:ring-accent transition-all duration-300`}
              />
              {errors.email && (
            ...
            <div className="relative">
              ...
              <input
                ...
                } bg-background/50 text-text placeholder-text/50 focus:outline-none focus:ring-2 focus:ring-accent transition-all duration-300`}
              />
              <button
                type="button"
          ...
          <div className="mt-8 text-center text-sm text-textMuted">
            ...
            <Link
              to="/SignUp"
              className="text-accent hover:text-accentLight hover:underline font-medium"
            >
              Create your account
            </Link>
          </div>
          ...
          <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-text/70 text-lg leading-relaxed max-w-md">
                Access your personalized dashboard, connect with mentors, and
                continue building your professional network in the knowledge
                economy.
              </p>
              ...
              <div className="bg-gradient-to-r from-accent/10 to-accent-light/10 p-6 rounded-xl border border-accent/20">
                ...
                <div className="text-text/80 italic">
                  "The best way to learn is to teach others. Join discussions,

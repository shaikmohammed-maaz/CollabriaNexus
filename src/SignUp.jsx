  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-8 md:py-16 pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-20 right-20 w-80 h-80 bg-accentLight/10 rounded-full blur-3xl"
      ...
      <div className="w-full max-w-6xl bg-card rounded-2xl shadow-2xl flex overflow-hidden relative z-10 border border-border">
        ...
        <div className="flex-1 p-10 lg:p-12 flex flex-col justify-center">
          ...
          <p className="mb-8 text-textMuted text-lg">
            Start your journey of knowledge sharing and collaboration
          </p>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start text-sm mt-6">
              ...
              <label
                htmlFor="accept"
                className="text-textMuted select-none leading-relaxed"
              >
                I agree to the{" "}
                <a
                  href="#"
                  className="text-accent hover:text-accentLight underline"
                >
                  Terms of Service
                </a>{" "}
                and{" "}
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-background/80 to-card/50 p-12 relative">
          <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-accentLight">
                Join the Knowledge Revolution
              </h3>
              <p className="text-textMuted text-lg leading-relaxed max-w-md">
                Connect with experts, share insights, and collaborate on
